@echo off
chcp 65001
echo [Gongmyung Installer] Installing System-wide Resonance Daemon...
...
echo.
echo [Success] Gongmyung Daemon has been installed to Startup.
echo It will run automatically when you log in.
echo.
echo To start it now, press any key...
pause >nul

start "" "%PYTHON_EXE%" "%DAEMON_SCRIPT%"
