...
try:
    ...
    # Process turns 100 to 110 (indices 99 to 109)
    # Note: User asked for "100 to 110". 
    # Index 99 is Turn 100. Index 109 is Turn 110.
    start_index = 99
    end_index = 110
    
    print(f"Analyzing {file_path} (Turns 100-110)...")
    ...
    for i in range(start_index, min(end_index, len(requests))):
        ...
        print(f'[{i+1}] User: {user_text[:150].replace(chr(10), " ")}...')
